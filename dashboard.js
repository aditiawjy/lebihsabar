(function() {
    ...
    var LIVE_STATE_SCHEMA_VERSION = '2026-04-30-rules-v124';
    ...
    function matchesSummaryPatternLive(pid, s) {
        ...
        switch (pid) {
            ...
            case 'P71': return s.league === '20min' && s.away === 'Germany (V)' && s.sc_a > s.sc_h && s.h1_last >= 6 && !(s.h1_first === 4 && s.h1_last === 9 && arrayEqualsJS(s.h1s, ['A', 'A']) && s.sc_h === 0 && s.sc_a === 2);

(function() {
    ...
    function matchesSummaryPatternLive(pid, s) {
        ...
        switch (pid) {
            ...
            case 'P15': return s.sc_h === 2 && s.sc_a === 2 && s.max_gap <= 2 && !(s.league === '15min' && arrayEqualsJS(s.h1s, ['A', 'H', 'H', 'A']) && s.h1.length === 4 && s.h1[0].min === 1 && s.h1[1].min === 2 && s.h1[2].min === 4 && s.h1[3].min === 6);

(function() {
    ...
    function matchesSummaryPatternLive(pid, s) {
        ...
        switch (pid) {
            ...
            case 'P6': return s.h1c === 2 && s.sc_h === 1 && s.sc_a === 1 && s.h1_last === 7 && span >= 5 && s.h1_first !== 1 && ['Manchester City (V)', 'Atletico de Madrid (V)'].indexOf(s.home) === -1;
            ...
            case 'P35': return inTeamConfig('p35_teams', s.away) && s.h1c >= 2 && s.h1_first >= 3 && s.max_run <= 2 && s.h1_last >= 5;
            ...
            case 'P53': return s.league === '20min' && s.h1_last === 3 && (lastScorer === 'H' || s.h1_first <= 1) && s.min_gap >= 1 && s.h1c <= 2;
    ...
    function matchesNextPatternLive(pid, s) {
        ...
        switch (pid) {
            case 'NG6':
                return s.league === '20min' && s.sc_h === 1 && s.sc_a === 1 && s.h1_last === 7 && span >= 5 && arrayEqualsJS(s.h1s, ['A', 'H']) && !(s.home === 'Mexico (V)' && s.away === 'Tunisia (V)');
            case 'NG7':
                return s.h1c >= 3 && s.max_gap >= 5 && Math.abs(s.sc_h - s.sc_a) === 2 && s.h1_last >= 8;
            case 'NG8':

...
function computeNextPatterns(array $matches): array {
    return [
        ...
        ['id'=>'NG2','label'=>'HOME unggul HT + gol terakhir mnt 3','next'=>'HOME','data'=>array_values(array_filter($matches, fn($m) => $m['h1c']>=1 && $m['sc_h']>$m['sc_a'] && $m['h1_last']==3))],
        ['id'=>'NG3','label'=>'HT 1-0, league 16min','next'=>'HOME','data'=>array_values(array_filter($matches, fn($m) => $m['league']==='16min' && $m['h1c']>=1 && $m['sc_h']==1 && $m['sc_a']==0))],
        ['id'=>'NG4','label'=>'HT 1-0 + gol mnt 3, league 16min','next'=>'HOME','data'=>array_values(array_filter($matches, fn($m) => $m['league']==='16min' && $m['sc_h']==1 && $m['sc_a']==0 && $m['h1_last']==3))],

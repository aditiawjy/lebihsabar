...
let sentOneGoal2HSignals = new Set();
let sentTeamHtSignals = new Set();
...
let lastLoggedOddsByMatchKey = new Map();
...
function pruneLongRunningMatchState(activeMatches = [], nowMs = Date.now()) {
    ...
    sentOneGoal2HSignals = pruneSetByKnownMatches(sentOneGoal2HSignals);
    sentTeamHtSignals = pruneSetByKnownMatches(sentTeamHtSignals);

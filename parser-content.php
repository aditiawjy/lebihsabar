<div class="p-4 md:p-8 max-w-6xl mx-auto space-y-6 page-fade-in">
    ...
    <div class="bg-white rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-200 p-4 md:p-5">
        <div class="flex flex-wrap items-center justify-between gap-3 mb-3">
            ...
            <span id="serverClock" class="text-xs font-bold text-slate-500 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-100 tabular-nums">--:--:-- WIB</span>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-5 gap-2 md:gap-3">
            <div class="rounded-xl bg-indigo-50 border border-indigo-100 px-3 py-2.5">
                <span class="block text-[10px] font-bold uppercase tracking-wider text-indigo-400">Total Match</span>
                <strong id="metricTotalToday" class="text-xl font-black text-indigo-700">-</strong>
            </div>
            <div class="rounded-xl bg-emerald-50 border border-emerald-100 px-3 py-2.5">
                <span class="block text-[10px] font-bold uppercase tracking-wider text-emerald-500">Liga Aktif</span>
                <strong id="metricLeagueActive" class="text-xl font-black text-emerald-700">-</strong>
            </div>
            <div class="rounded-xl bg-amber-50 border border-amber-100 px-3 py-2.5">
                <span class="block text-[10px] font-bold uppercase tracking-wider text-amber-500">Belum Ada Skor</span>
                <strong id="metricPendingScore" class="text-xl font-black text-amber-700">-</strong>
            </div>
            <div class="rounded-xl bg-rose-50 border border-rose-100 px-3 py-2.5">
                <span class="block text-[10px] font-bold uppercase tracking-wider text-rose-400">Invalid (Input)</span>
                <strong id="metricInvalidData" class="text-xl font-black text-rose-700">0</strong>
            </div>
            <div class="rounded-xl bg-slate-50 border border-slate-200 px-3 py-2.5">
                <span class="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Duplicate (Input)</span>
                <strong id="metricDuplicate" class="text-xl font-black text-slate-700">0</strong>
            </div>
        </div>
    </div>
